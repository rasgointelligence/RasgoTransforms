...
{%- set subset = get_columns(source_table) -%} {%- set source_col_names = subset -%}
{%- endif -%}

{%- if how is not defined -%} {%- set how = "any" -%} {%- endif -%}
...
{%- else -%}
{%- if thresh is not defined -%} {%- set thresh = subset|length -%}
{%- endif -%}
...
select
    {% for col in source_col_names -%} {{ col }}{{ ", " if not loop.last else " " }}
    {%- endfor %}
from not_null
{%- endif -%}
